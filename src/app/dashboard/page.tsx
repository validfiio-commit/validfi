  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-7 py-9">
        ...
        {/* Moltlaunch Agent Widget */}
        <div className="rounded-xl bg-surface border border-border mb-8 overflow-hidden animate-fade-in cursor-pointer hover:border-border-hover transition-all"
          onClick={() => router.push("/moltlaunch")}>
          <div className="px-7 py-4 border-b border-border flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-green animate-pulse" />
              <span className="text-[11px] font-mono text-ivory-dim tracking-[2px] uppercase">Hire ValidFi Agent on Moltlaunch</span>
            </div>
            <span className="text-[9px] font-mono text-ivory-dim/40 tracking-wider">LIVE ON BASE</span>
          </div>
          <div className="px-7 py-4 flex items-center justify-between">
            <div className="flex items-center gap-5">
              <div>
                <div className="text-[9px] font-mono text-ivory-dim/40 tracking-[2px] uppercase mb-0.5">Agent</div>
                <div className="text-sm font-bold">ValidFi <span className="text-accent font-mono text-xs">#{`18886`}</span></div>
              </div>
              <div>
              ...
              <div className="hidden sm:block">
                ...
                <div className="text-sm text-ivory-dim">Validation · Wallet Analysis · AI Advisor</div>
              </div>
            </div>
            <div className="flex items-center gap-2.5">
              <a href="https://flaunch.gg/base/coin/0x8b7583b93ea81450af3caf3b7c71e43eb1d73ae8" target="_blank" rel="noopener noreferrer"
                onClick={e => e.stopPropagation()}
                className="text-[10px] font-mono px-3 py-1.5 rounded bg-purple-muted text-purple border border-purple/20 hover:border-purple/40 transition-colors">
                Trade ↗
              </a>
              <a href="https://basescan.org/token/0x8b7583b93ea81450af3caf3b7c71e43eb1d73ae8" target="_blank" rel="noopener noreferrer"
                onClick={e => e.stopPropagation()}
                className="text-[10px] font-mono px-3 py-1.5 rounded bg-surface-2 text-ivory-dim border border-border hover:border-border-hover transition-colors">
                Basescan ↗
              </a>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(238,234,226,0.25)" strokeWidth="1.5" className="shrink-0">
